...
const Banner = () => {
    return (
        <div className="w-11/12 md:w-10/12 mx-auto flex flex-col md:flex-row md:justify-between items-center bg-gradient-to-b md:bg-gradient-to-r from-[#151925] to-black relative">
